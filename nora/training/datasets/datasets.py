...
class RLDSBatchTransform:
    ...
    def __call__(self, rlds_batch: Dict[str, Any]) -> Dict[str, Any]:
        ...
        #img2 = Image.fromarray(rlds_batch["observation"]["image_primary"][1])
        ...
        return dict(proprio=rlds_batch["observation"]['proprio'],action=action,image=image,lang=lang, dataset_name=dataset_name)
